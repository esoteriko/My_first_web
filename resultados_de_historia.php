...
<table border="0" align="center"><tr><td><?php echo"Sesión de $usuario"; ?></td></tr></table>
<?php
...
//Base de datos
//$link = mysql_connect("localhost","root","fundacion","resultados");
//mysql_select_db("resultados",$link);


//$sql="INSERT INTO `resultados`( `usuario` , `A` , `B`  ,`C` , `D` , `E`) 
//VALUES ('$usuario', '$A', '$B', '$C','$D','$E');";
